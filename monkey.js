...
var audio = new Audio("monkey-mocking-laugh.wav");
    document.onclick = function() {
        audio.play();
    }

//petIcon//
document.getElementById("petIcon").src="cyberMonkey1.png";
